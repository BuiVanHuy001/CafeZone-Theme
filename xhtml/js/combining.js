...
jQuery(document).ready(function () {
    ...
    "use strict";
    setTimeout(function () {
        jQuery(".main-slider").data("owl.carousel")._invalidated.width = !0, jQuery(".main-slider").trigger("refresh.owl.carousel")
    }, 2e3)
});
...
var CafeZone = function () {
    ...
    var e = $(window).width(), t = function () {
        ...
        e <= 991 && jQuery(".navbar-nav > li > a, .sub-menu > li > a").unbind().on("click", function (e) {
            jQuery(".navbar-nav > li > a, .sub-menu > li > a").not(this).next(".sub-menu").slideUp(), jQuery(this).next(".sub-menu").toggle(500), jQuery(this).parent().hasClass("open") ? jQuery(this).parent().removeClass("open") : (jQuery(this).parent().parent().find("li").removeClass("open"), jQuery(this).parent().addClass("open"))
    ...
    return {
        init: function () {
            $(".wow").length > 0 && new WOW({
                ...
                offset: 50,
                mobile: !1
            }).init(), i(), t(), $(".openbtn").on("click", function (e) {
                e.preventDefault(), $("#mySidenav").length > 0 && (document.getElementById("mySidenav").style.left = "0")
            }), $(".closebtn").on("click", function (e) {
                e.preventDefault(), $("#mySidenav").length > 0 && (document.getElementById("mySidenav").style.left = "-100%")
            }), e > 768 && $(".content-scroll").length > 0 && $(".content-scroll").mCustomScrollbar({
                setWidth: !1,
                setHeight: !1,
                axis: "y"
            }), function () {
            ...
            }(a), jQuery(".modal").on("show.bs.modal", n)
        }, load: function () {
            jQuery("select").length && jQuery("select").selectpicker(), function () {
                "use strict";
                ...
                jQuery(".filters").length && (jQuery(".filters li:first").addClass("active"), jQuery(".filters").on("click", "li", function (t) {
                    t.preventDefault();
...
jQuery(document).ready(function () {
    ...
    "use strict";
    CafeZone.load(), setTimeout(function () {
